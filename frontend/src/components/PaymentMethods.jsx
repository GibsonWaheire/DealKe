...
//   serviceName    — label shown in Paystack dashboard
//   category       — optional (e.g. "KRA", "Shop")
//   description    — optional project notes from the form
//   customerEmail  — pre-fill Paystack email field
//   customerPhone  — passed to Paystack metadata
            ...
            <div className="py-3">
              ...
              <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-4 mb-4 space-y-2.5">
                ...
                <div className="flex justify-between items-center pt-2.5 border-t border-zinc-200">
                  ...
                  <button
                    onClick={() => copyText(paystackRef, setCopiedRef)}
              ...
              <div className="mb-5">
                ...
                <div className="space-y-2.5">
                  {[
                    ...
                    "We'll confirm and start your service within a few hours.",
              ...
              {/* WhatsApp CTA */}
              <a
                href={buildWaUrl('Card / Apple Pay / Paystack', paystackRef)}
                target="_blank"
                rel="noreferrer"
              ...
              <p className="text-zinc-400 text-xs text-center mt-3">
                Save your ref: <span className="font-mono text-zinc-600">{paystackRef}</span>
              </p>
            </div>
          ) : (
            <div>
