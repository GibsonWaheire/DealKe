          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-slate-50 border border-gray-100 rounded-2xl p-6">
                <p className="text-slate-900 font-semibold text-sm mb-1">Ready to get started?</p>
                <p className="text-slate-500 text-sm mb-4">
                  Pay directly for any service — M-Pesa, card, or Apple Pay. We start immediately after payment.
                </p>
                <Link
                  to="/pay"
