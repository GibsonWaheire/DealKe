export const WA_NUMBER = '254726899113'
export const WA_PHONE = '+254 726 899 113'
export const TILL = '4703506'

export const serviceChips = ['KRA', 'Websites', 'NTSA', 'Documents', 'IT & Networking', 'POS & ERP']
...
export const heroSlides = [
  ...
  },
  {
    ...
    sub: 'Home networking, office IT, POS systems, TV installation.',
...
export const templateCategories = [
  {
    ...
    templates: [
      { name: 'Buy Goods Till Number Template', price: 150 },
      { name: 'Lipa Na M-Pesa Pay Bill Number Template', price: 150 },
      { name: 'Lipa Na Pochi La Biashara Template', price: 150 },
      { name: 'M-Pesa Agent Number Sticker', price: 150 },
    ],
  },
  {
    id: 'financial', label: 'Financial',
    templates: [
      { name: 'Delivery Note Template', price: 150 },
      { name: 'Invoice Template', price: 150 },
      { name: 'Cash Sale Receipt Template', price: 150 },
      { name: 'Petty Cash Voucher Template', price: 150 },
      { name: 'Payroll Deduction Authorization Form', price: 150 },
      { name: 'Salary Advance Request Template', price: 150 },
      { name: 'Fixed Asset Register Template', price: 150 },
    ],
  },
  {
    id: 'legal', label: 'Legal & Agreements',
    templates: [
      { name: 'Business Shop Lease Agreement', price: 150 },
      { name: 'Land Lease Agreement', price: 150 },
      { name: 'Land Sale Agreement', price: 150 },
      { name: 'Car Lease Agreement', price: 150 },
      { name: 'Car Sale Agreement', price: 150 },
      { name: 'Motorbike Lease Agreement', price: 150 },
      { name: 'Motorbike Sales Agreement', price: 150 },
      { name: 'Business Partnership Agreement', price: 150 },
      { name: 'Managed IT Services Agreement', price: 150 },
      { name: 'Independent Contractor Agreement', price: 150 },
      { name: 'Shareholder Loan Agreement', price: 150 },
      { name: 'Freelance Graphic Design Contract', price: 150 },
      { name: 'Contractor Non-Disclosure Agreement', price: 150 },
    ],
  },
  {
    id: 'hr', label: 'HR & Employment',
    templates: [
      { name: 'Employment Agreement Form', price: 150 },
      { name: 'Employment Verification Letter', price: 150 },
      { name: 'Job Confirmation Letter', price: 150 },
      { name: 'Employee Suspension Letter', price: 150 },
      { name: 'Termination Letter', price: 150 },
      { name: 'Workplace Incident Report Form', price: 150 },
      { name: 'Company Policy Acknowledgement Form', price: 150 },
    ],
  },
  {
    id: 'academic', label: 'Academic',
    templates: [
      { name: 'Scholarship CV Template', price: 150 },
      { name: 'Scholarship Motivation Letter', price: 150 },
      { name: 'Scholarship Thank You Letter', price: 150 },
      { name: 'School Infrastructure Development Plan', price: 150 },
      { name: 'BOM Minutes Template', price: 150 },
    ],
  },
  {
    id: 'career', label: 'Career & CV',
    templates: [
      { name: 'Simple Cover Letter Template', price: 150 },
      { name: 'General Cover Letter Template', price: 150 },
      { name: 'Application Letter for Attachment', price: 150 },
      { name: 'Simple CV Template', price: 150 },
      { name: 'General CV Template', price: 150 },
      { name: 'Letter of Intent for Job Promotion', price: 150 },
      { name: 'Thank You Letter Template', price: 150 },
    ],
  },
  {
    id: 'medical', label: 'Medical & Legal',
    templates: [
      { name: 'Medical Form Template (PDF)', price: 150 },
      { name: 'Last Will Template', price: 150 },
    ],
  },
]
...
export const microServices = [
  {
    ...
    services: [
      ...
      { name: 'PDF Print-Ready Cleanup', price: 150 },
      { name: 'NTSA TIMS Account Setup', price: 250 },
      { name: 'KRA Tax Compliance Certificate', price: 350 },
      { name: 'Scan & Email Documents', price: 150 },
      { name: 'ID / Passport Photocopy Prep', price: 150 },
      { name: 'Form Filling Assistance', price: 150 },
    ],
  },
  {
...
export const toolCards = [
  ...
  { icon: '📄', title: '50+ Templates', desc: 'Legal, HR, finance & more — KES 150' },
]
